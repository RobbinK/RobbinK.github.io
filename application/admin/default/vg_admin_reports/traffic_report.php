                ...
                <form id="myform" method="post" action="<?= url::itself()->url_nonqry() ?>">
                    ...
                    <div class="span2">
                        <div class="input-large  input-append date" id="dp2" data-date-format="yyyy-mm-dd">
                            <?=L::global_pre_to;?> <input type="text" class="span6"  name="date2" id="dp2"  data-default="<?= $date['today'] ?>" readonly><span class="add-on"><i class="splashy-calendar_day"></i></span>
                        </div>
                    </div>
                    <div class="span2">
        ...
        <table id="dt_e" class="table table-striped table-bordered dTableR" >
            <thead>
                <tr> 
                    ...
                    <th><?=L::forms_tier1_visits;?></th>
                    <th><?=L::forms_tier2_visits;?></th>
                    <th><?=L::forms_tier3_visits;?></th>
                    <th><?=L::forms_total_visits;?></th>
                    <th><?=L::forms_pageviews;?></th>  
                    <th><?=L::forms_pageviews_avg;?></th>  
                    <th><?=L::forms_bounce_rate;?></th>  
                    <th><?=L::forms_games_played;?></th>  
                </tr>
            </thead>
    ...
    $(document).ready(function() {
        ...
        oTable = $('#dt_e').dataTable({
            ...
            aoColumnDefs: [
                ...
                {aTargets: [6], sWidth: '50px', "sType": "numeric"},
                {aTargets: [7], sWidth: '50px', "sType": "formatted-num"},
