        ...
        <nav>
            <div id="jCrumbs" class="breadCrumb module">
                <ul>
                    ...
                    <li>
                        <?=L::sidebar_site_earn_rep;?>
                    </li>
                </ul>
            </div>
        </nav>

        <font style="font:15px Arial  bold;"><?=L::forms_earning_report_for;?> </font> 
        <span class="label label-info sepH_c">
            <h4><?= $domain ?></h4>
        </span>
        <!-- /Navigation Menu -->
        <!-- form --> 
        ...
        <table id="dt_e" class="table table-striped table-bordered dTableR" >
            <thead>
                <tr> 
                    ...
                    <th><?=L::forms_impressions;?></th>
                    <th><?=L::forms_clicks;?></th>
                    <th><?=L::forms_total_earning;?></th>
                </tr>
            </thead>
    ...
    $(document).ready(function() {
        ...
        oTable = $('#dt_e').dataTable({
            ...
            aoColumnDefs: [
                ...
                {aTargets: [1], sWidth: '70px', "sType": "currency"},
                {aTargets: [2], sWidth: '50px', "sType": "currency"},
                {aTargets: [3], sWidth: '70px', "sType": "currency"}
            ],
            sDom: 'f<"toolbar">rtip',
