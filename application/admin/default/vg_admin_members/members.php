    ...
    <div class="main_content">
        ...
        <div id="form_div" class="tab-content" style="visibility:visible ">
            ...
            <form id="myform" method="post" action="<?= url::itself()->fulluri() ?>" class="form_validation_reg" novalidate="novalidate">
                ...
                <!--+++ST Tab++++--> 
                <div class="tabbable"  id="member_acc">  
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#tab1" data-toggle="tab"><?= L::forms_basic_info; ?></a></li>
                        <li><a href="#tab2" data-toggle="tab"><?= L::forms_contact_info; ?></a></li>
                        <li><a href="#tab3" data-toggle="tab"><?= L::forms_avatar; ?></a></li>
                        <li><a href="#tab4" data-toggle="tab"><?= L::forms_hits; ?></a></li>
                    </ul>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab1">  
                            <dl class="dl-horizontal"> 
                                ...
                                <dd><div><input type="text" name="username" id="username" value="" required></div></dd>

                                <dt><label> <?= L::forms_password; ?> </label></dt>
                                <dd><div><input type="password" name="password" id="password" value="" ></div></dd>

                                <dt><label> <?= L::forms_group; ?> </label></dt>
                                <dd>
                                    <div>
                                        <select name="group"  id="group"  class="input-medium">  
                                            <?php while ($MemberGroup->fetch()) : ?>
                                                <option value="<?= $MemberGroup->current()->id ?>"><?= $MemberGroup->current()->group_name ?></option>
                                            <?php endwhile; ?>
                                        </select> 
                                    </div>
                                </dd>

                                <dt><label><?= L::forms_name; ?> </label></dt>
                                <dd><div><input type="text" name="name" id="name"  value="" ></div></dd> 

                                <dt><label><?= L::forms_email; ?> </label></dt>
                                <dd><div><input type="email" name="email" id="email"  value="" ></div></dd> 

                                <dt><label><?= L::forms_gender; ?> </label></dt>
                                <dd>
                                    <div>
                                        <select name="gender"  id="gender" style="width: 100px">                                                    
                                            <option value="male"><?= L::forms_male; ?></option>
                                            <option value="female"><?= L::forms_female; ?></option>
                                        </select> 
                                    </div></dd>
                        ...
                        <div class="tab-pane" id="tab2">  
                            <dl  class="dl-horizontal">  
                                <dt><label> <?= L::forms_domain ?> </label></dt>
                                <dd><div><input type="url" name="website" id="website"  data-default="http://" ></div></dd>

                                <dt><label> Msn </label></dt>
                                <dd>
                                    <div class="input-prepend">
                                        <span class="add-on"><i class="social-msn"></i></span><input type="text" class="input-medium" name="msn" id="msn"  value="" >
                                    </div>
                                </dd>
                                ...
                                <dd>
                                    <div class="input-prepend">
                                        <span class="add-on"><i class="social-skipe"></i></span><input type="text" class="input-medium" name="skipe" id="skipe"  value="" >
                                    </div>
                                </dd>
                                ...
                                <dd>
                                    <div class="input-prepend">
                                        <span class="add-on"><i class="social-icq"></i></span><input type="text" class="input-medium" name="icq" id="icq"  value="" >
                                    </div>
                                </dd>  

                                <dt><label> AIM </label></dt>
                                <dd>
                                    <div class="input-prepend">
                                        <span class="add-on"><i class="social-aim"></i></span><input type="text" class="input-medium" name="aim" id="aim"  value="" >
                                    </div>
                                </dd>   

                                <dt><label> Yahoo </label></dt>
                                <dd>
                                    <div class="input-prepend">
                                        <span class="add-on"><i class="social-yahoo"></i></span><input type="text" class="input-medium" name="yahoo" id="yahoo"  value="" >
                                    </div>
                                </dd>    

                                <dt><label> Google Talk </label></dt>
                                <dd>
                                    <div class="input-prepend">
                                        <span class="add-on"><i class="social-gmail"></i></span><input type="text" class="input-medium" name="google_talk" id="google_talk"  value="" >
                                    </div>
                                </dd>     
                                <dt><label> <?= L::forms_comment ?> </label></dt>
                                <dd><div><textarea id="quote" name="quote"></textarea></div></dd>
                            </dl>  
                        </div>
                        <!--++TB3++--> 
                        <div class="tab-pane" id="tab3" style="height: 200px">  
                            <dt><label> <?= L::forms_avatar; ?> </label></dt>
                            <dd>
                                <div>
                                    <input type="button" id="upload-btn" class="btn btn-large clearfix" value="<?= addslashes(L::forms_select_file);?>">
                                    <input type="hidden" name="avatar" id="avatar"  value="" >
                                    <span class="help-inline"><i>PNG, JPG, or GIF (<?= L::forms_max_file_size; ?> 200K)</i></span>
                                    <div id="errormsg" class="clearfix redtext"></div>	              
                                    <div id="pic-progress-wrap" class="progress-wrap" style="margin-bottom:10px;"></div>	                    
                                    <div id="picbox" class="noimg clear" style="position: relative;height:60px;padding-top:0px;padding-bottom:10px;"> 
                                        <img class="thumbnail" style="width:100px;height:100px;" src="http://www.placehold.it/100x100/EFEFEF/AAAAAA&amp;text=no+image" alt=""> 
                                    </div>
                                </div>                                        
                            </dd> 
                        </div> 
                        ...
                        <div class="tab-pane" id="tab4"> 
                            <dl class="dl-horizontal">
                                <dt><?= L::forms_last_login; ?></dt>
                                <dd> <label id="lastlogin" class="input-block-level"></label></dd>
                                <dt><?= L::forms_total_logins; ?></dt>
                                <dd> <label id="login"  class="input-block-level"></label></dd>
                                <dt><?= L::forms_register_date; ?></dt>
                                <dd> <label id="regdate" class="input-block-level"></label></dd> 
                                <dt><?= L::forms_ip; ?></dt>
                                <dd> <label id="ip_info_range" class="input-block-level"></label></dd>
                                <dt><?= L::global_country; ?></dt>
                                <dd> <label id="ip_info_country" class="input-block-level"></label></dd>
                            </dl> 
                        </div>
                        <!--+++END Acardion++++-->
                    </div>
                ...
                <dl  class="dl-horizontal">
                    ...
                    <dd>
                        <div>
                            ...
                            &nbsp;&nbsp;
                            <input class="btn" type="button" name="reset" value="<?= addslashes(L::forms_new_member);?>" onclick="reset_form();
                                    return false;" />
                            &nbsp;&nbsp;
        ...
        <!-- Members List -->
        <h3 class="heading"><?= L::sidebar_mem_list; ?>
            <button class="pull-right btn btn-info  bt_add_new"   onclick=""><?= L::forms_new_member ?></button> 
...
<script type="text/javascript">
                                ...
                                $(document).ready(function() {
                                    ...
                                    oTable = $('#dt_e').dataTable({
                                        ...
                                        aoColumnDefs: [
                                            ...
                                            {aTargets: [6], sWidth: '7%'},
                                            {aTargets: [7], sWidth: '7%'},
                                            {bSortable: false, aTargets: [8], sWidth: '7%'}
                                        ],
                                        bAutoWidth: false,
                                        sDom: 'f<"toolbar">rtip',
        ...
        <button class="btn btn-mini sepV_a btn-danger mdel" style="display:none"><li class="icon-trash"></li> <?= L::global_delete_selected; ?></button>\n\
                                ...
                                function reset_form() {
                                    ...
                                    $('#div_title').html('<?= addslashes(L::forms_add_new_member);?>');

                                    $('#member_acc a:first').tab('show');
                                }
                                ...
                                function reg_dt_edit() {
                                    $('.edit').click(function() {
                                        ...
                                        reset_form();
                                        $('#div_title').html('<?= addslashes(L::forms_edit_member);?>');
                                        open_form();
                                        $('#myform').showLoading(loading_config);
                                        $.ajax({
                                            type: 'POST',
                                            ...
                                            success: function(result) {
                                                ...
                                                $('#ip_info_range').html(data.ip_info_range);
                                                $('#ip_info_country').html(data.ip_info_country);
                                                ...
                                                if (typeof(data.avatar) != 'undefined' && data.avatar != '') {
                                                    open_uploader_picbox('#picbox', data.avatar);
