...
##
## File Name: arcade_discussions.php
## Version : 1.5.7.4
        ...
        <nav>
            <div id="jCrumbs" class="breadCrumb module">
                <ul>
                    ...
                    <li><?=L::header_arcade_discussions;?></li>
                </ul>
            </div>
        </nav>
        <!-- /Navigation Menu -->
        <!-- Page Lists -->
        <h3 class="heading"><?=L::header_arcade_discussions;?></h3> 
        <div class="row-fluid">
            <div class="span12">
                <div class="mbox">
                    <div class="tabbable">
...
<script type="text/javascript">
    ...
    function  reg_dt_show() {
        $('.open').click(function() {
            ...
            $.colorbox({href: "google.com?" + "&view_post_id=" + eid});
        });
    }
