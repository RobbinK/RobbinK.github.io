...
<div id="contentwrapper">
    <div class="main_content"> 
        ...
        <!-- Members List -->
        <h3 class="heading">Messages List </h3>
    ...
    $(document).ready(function() {
        ...
        oTable = $('#dt_e').dataTable({
            ...
            aoColumnDefs: [
                ...
                {bSearchable: false,aTargets: [3], sWidth: '100px'},
                {bSearchable: false,aTargets: [4], sWidth: '70px'},
                {aTargets: [5]},
                {bSearchable: false, bSortable: true, aTargets: [6], sWidth: '10px'},
                {bVisible: true, bSearchable: false, bSortable: false, aTargets: [7], sWidth: '10px', sClass: 'center'},
