...
<div id="contentwrapper">
    <div class="main_content"> 
        ...
        <div id="form_div" class="tab-content" style="visibility:visible ">
            ...
            <form id="myform" method="post" action="<?= url::itself()->fulluri() ?>" class="form_validation_reg" novalidate="novalidate">
                ...
                <dl class="dl-horizontal">
                    ...
                    <dt><label><?= L::forms_category_name; ?></label></dt>
                    <dd>
                        <div>
                    ...
                    <dd><div><textarea name="meta_keywords" id="meta_keywords" row="2" class="input-xlarge auto_expand"></textarea></div></dd>

                    <dt><label><?= L::forms_meta_description; ?></label></dt>
                    <dd><div><textarea  name="meta_description" id="meta_description"  row="2" class="input-xlarge auto_expand"></textarea></div></dd>

                    <dt><label><?= L::forms_feed_tags_matching; ?></label></dt>
                    <dd>
                        <div>
                            <select name="feed_tag_matching" id="feed_tag_matching"  style="width:300px" class="hidden"  multiple="multiple">
                                <?php
                                $cats = setting::get_data('feed_categories', 'val');
                    ...
                    <dt><label><?= L::forms_category_icon; ?></label></dt>
                    <dd>
                        <div>
                            <input type="button" id="upload-btn" class="btn btn-large clearfix" value="<?= addslashes(L::forms_select_file);?>"/>
                            <input type="hidden" name="icon" id="icon"  value="" />
                            <span class="help-inline"><i>PNG, JPG, GIF (<?= L::forms_max_file_size; ?> : 500 <?= L::global_kilo_byte; ?>)</i></span>
                            <div id="errormsg" class="clearfix redtext"></div>	              
                            <div id="pic-progress-wrap" class="progress-wrap" style="margin-bottom:10px;"></div>	
                            <div id="filebox" class="clear" style="position: relative;padding-top:0px;padding-bottom:10px"></div>
                    </dd>

                    <dt><label>Description </label></dt>
                    <dd>
                        <div class="sepH_b"><textarea  name="description" id="description" class="tinymce auto_expand" style="width:700px" ></textarea></div>
                    </dd>
                    ...
                    <dd> 
                        <div>
                            ...
                            &nbsp;&nbsp;
                            <input class="btn" type="button" name="reset" value="<?= addslashes(L::forms_new_category);?>" onclick="reset_form();
                                    return false;"/>
                            &nbsp;&nbsp;
        ...
        <!-- Categories List -->
        <h3 class="heading"><?= L::forms_categories_list; ?>
            <button class="pull-right btn btn-info  bt_add_new"   onclick=""><?= L::forms_add_new_category; ?></button> 
        ...
        <table id="dt_e" class="table table-striped table-bordered dTableR" >
            <thead>
                <tr>
                    <th>ID</th>
                    <th><?= L::forms_category_name; ?></th>
                    <th><?= L::forms_meta_keywords; ?></th>
                    <th><?= L::forms_meta_description; ?></th>
                    <th><?= L::forms_featured; ?></th>
...
<script type="text/javascript">
                                ...
                                $(document).ready(function() {
                                    ...
                                    oTable = $('#dt_e').dataTable({
                                        ...
                                        aoColumnDefs: [
                                            ...
                                            {bSortable: false, aTargets: [6], sWidth: '60px'}
                                        ],
                                        sDom: 'f<"toolbar">rtip',
        ...
        <button class="btn btn-mini sepV_a btn-danger mdel" style="display:none"><li class="icon-trash"></li><?= L::global_delete_selected; ?></button>\n\
                                ...
                                function reset_form() {
                                    ...
                                    $('#div_title').html('<?= addslashes(L::forms_add_new_category);?>');
                                ...
                                function reg_dt_edit() {
                                    $('.edit').click(function() {
                                        ...
                                        reset_form();
                                        $('#div_title').html('<?= addslashes(L::forms_edit_category);?>');
                                        open_form();
                                        $('#myform').showLoading(loading_config);
                                        $.ajax({
                                            type: 'POST',
                                ...
                                function open_uploader_imagebox(jQid, dbField, filename) {
                                    ...
                                    $(jQid).fadeOut(300, function() {
                                        html = '<img src="<?= url::itself()->url_nonqry() ?>?showimage=' + encodeURIComponent(filename) + '&size=90xauto" rel="clbox" >';
                                        html += '<span style="top: 0px; position: absolute; margin:0 10px;">' + filename + '</span>';
                                        html += '<a style="position: absolute; top: 23px; margin:0 10px;cursor:pointer;" onclick="delete_file(\'' + dbField + '\');return false;" class="btn-danger btn-mini deleteicon"><?= L::global_remove; ?></a>';
                                        if ($(jQid).hasClass('noimg')) {
