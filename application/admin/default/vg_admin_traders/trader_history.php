        ...
        <table id="dt_e" class="table table-striped table-bordered dTableR" >
            <thead>
                <tr> 
                    ...
                    <th><?=L::forms_tier1_in;?></th>
                    <th><?=L::forms_tier2_in;?></th>
                    <th><?=L::forms_tier3_in;?></th>
                    <th><span class="text-error"><?=L::forms_total_in;?></span></th>
                    <th><?=L::forms_tier1_out;?></th>
                    <th><?=L::forms_tier2_out;?></th>
                    <th><?=L::forms_tier3_out;?></th>  
                    <th><span class="text-error"><?=L::forms_total_out;?></span></th>
                    <th><?=L::forms_convert;?></th>  
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#dt_e').dataTable({
            ...
            aoColumnDefs: [
                ...
                {aTargets: [5], sWidth: '50px', "sType": "currency"},
                {aTargets: [6], sWidth: '50px', "sType": "currency"},
                {aTargets: [7], sWidth: '50px', "sType": "currency"},
                {aTargets: [8], sWidth: '50px', "sType": "currency"},
                {aTargets: [9], sWidth: '60px', "sType": "currency"},
                {aTargets: [10], sWidth: '50px', "sType": "numeric"},
                {aTargets: [11], sWidth: '50px', "sType": "formatted-num"}
            ],
            sDom: 'f<"toolbar">rtip',
    ...
    function reset_form() {
        ...
        //date
        $('#myfrom').find('input').each(function() {
