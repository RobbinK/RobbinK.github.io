...
<div id="contentwrapper">
    <div class="main_content"> 
        ...
        <div id="form_div" class="tab-content" style="visibility:visible ">
            ...
            <form id="myform" method="post" action="<?= url::itself()->fulluri() ?>" class="form_validation_reg" novalidate="novalidate">
                ...
                <dl class="dl-horizontal">
                    ...
                    <p class="well well-small" id="block_snipped">
                        <?=L::forms_place_block;?><br><br>
                        <code style='direction:ltr'></code>
                    </p>

                    <dt><label> <?=L::forms_block_name?></label></dt>
                    <dd>
                        <div><input type="text" name="block_title" id="block_title" value="" size="50" required></div> 
                    </dd>

                    <dt><label><?=L::forms_block_content?> </label></dt>
                    <dd> 
                        <div class="sepH_b"><textarea  name="block_content" id="block_content" class="tinymce auto_expand" style="width:700px" ></textarea></div>
                    </dd> 
                    ...
                    <dd> 
                        <div>
                            ...
                            &nbsp;&nbsp;
                            <input class="btn" type="button" name="reset" value="<?= addslashes(L::forms_new_block);?>" onclick="reset_form();
                                    return false;" />
                            &nbsp;&nbsp;
        ...
        <!-- Block Lists -->
        <h3 class="heading"><?=L::forms_block_list?>
            <button class="pull-right btn btn-info  bt_add_new"   onclick=""><?=L::forms_new_block?></button> 
...
<script type="text/javascript">
                                ...
                                $(document).ready(function() {
                                    ...
                                    oTable = $('#dt_e').dataTable({
                                        ...
                                        aoColumnDefs: [
                                            ...
                                            {bSortable: false, aTargets: [3], sWidth: '100px'},
                                        ],
                                        sDom: 'f<"toolbar">rtip',
                                ...
                                function reset_form() {
                                    ...
                                    $('#div_title').html('<?= addslashes(L::forms_new_block);?>');
                                    $('#block_snipped').hide();
                                }
                                            ...
                                            success: function(result) {
                                                ...
                                                if (obj.save_code === 1) {
                                                    ...
                                                    if ($('.form_validation_reg .edit_id').val() == '') {
                                                        ...
                                                        $('#block_snipped').show().find('code').html(obj.block_snipped);
                                                    }
                                                    return true;
                                                }
                                                else {
                                ...
                                function ajaxedit(eid) {
                                    reset_form();
                                    $('#div_title').html('<?= addslashes(L::forms_edit_block);?>');
                                    open_form();
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(result) {
                                            ...
                                            $('#block_snipped').show().find('code').html(data.block_snipped);
                                            if (typeof(tinyMCE) != 'undefined') {
                                                $.each(data, function(k, v) {
