        ...
        <div id="form_div" class="tab-content" style="visibility:visible ">
            ...
            <form id="myform" method="post" action="<?= url::itself()->fulluri() ?>" class="form_validation_reg" novalidate="novalidate">
                ...
                <dl class="dl-horizontal">
                    ...
                    <dt><label> <?= L::forms_link_title; ?> </label></dt>
                    <dd>
                        <div><input type="text" name="partner_title" id="partner_title" value="" size="50" required></div> 
                    </dd>
                    <dt><label> <?= L::forms_partner_url; ?> </label></dt>
                    <dd> 
                        <div><input type="url" name="partner_url" id="partner_url" value="" size="60" data-default='http://' required></div>
                    </dd>

                    <dt><label><?= L::forms_email; ?> </label></dt>
                    <dd><div><input type="email" name="partner_email" id="partner_email" value="" ></div></dd> 

                    <dt><label> <?= L::forms_expiration_date; ?>  </label></dt>
                    <dd>
                        <div>
                            <div class="input-append date" id="dp1" data-date-format="yyyy-mm-dd" data-date-autoclose="true" data-date-todayhighlight="true">
                    ...
                    <dd>
                        <div><input type="text" name="priority"  id="priority" value="" size="2" class="input input-mini"  required="true" digits="true"></div>
                    </dd>
...
<script type="text/javascript">
                                ...
                                $(document).ready(function() {
                                    ...
                                    oTable = $('#dt_e').dataTable({
                                        ...
                                        aoColumnDefs: [
                                            ...
                                            {bSortable: false, aTargets: [8], sWidth: '100px'},
                                        ],
                                        sDom: 'f<"toolbar">rtip',
                                ...
                                function reset_form() {
                                    ...
                                    $('#div_title').html('<?= addslashes(L::forms_add_new_link);?>');
                                }
