...
##
## File Name: inflector.class.old.php
## Version : 1.5.7.4
...
class Inflector {
    ...
    function __construct() {
        $this->inf = new InflectorClass();
    }

    public function get_plural($none) {
        $this->_plural = $this->inf->pluralize($none);
        return $this->_plural;
    }

    public function get_singular($none) {
        $this->_singular = $this->inf->singularize($none);
